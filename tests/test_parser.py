...
Test Coverage:
    - TestParseRunResults: Parse run_results.json file
    - TestParseManifest: Parse manifest.json file
    - TestResolveTestToModelNode: Resolve test to model node
    - TestExtractProjectName: Extract project name from unique_id
    - TestExtractModelName: Extract model name from test node
    - TestMapTestStatus: Map dbt status to boolean
    - TestBuildNamespace: Build namespace from manifest metadata
    - TestBuildDatasetInfo: Build dataset info from model/source node
    - TestExtractModelInputs: Extract model inputs (dependencies)
    - TestGetModelsWithTests: Get models with executed tests
    - TestGetExecutedModels: Get executed models from run results
    - TestExtractAllModelLineage: Extract lineage for all models
    - TestModelExecutionResult: ModelExecutionResult dataclass
    - TestExtractModelResults: Extract model execution results
...
# =============================================================================
# Tests for parse_run_results()
# =============================================================================


@pytest.mark.unit
class TestParseRunResults:
    """Tests for parsing dbt run_results.json file."""

    def test_parse_run_results(self) -> None:
    ...
    def test_parse_run_results_with_multiple_tests(self) -> None:
        ...
        assert (
            max(execution_times) < 10
        ), "Max execution time should be reasonable (<10s)"
        ...
        assert (
            len(test_types) >= 2
        ), f"Should have multiple test types, found: {test_types}"

    def test_parse_run_results_missing_file(self) -> None:
    ...
    def test_parse_run_results_malformed_json(self) -> None:
    ...
    def test_parse_run_results_missing_metadata(self) -> None:
    ...
    def test_parse_run_results_empty_results(self) -> None:
    ...
    def test_parse_run_results_openlineage_compliance(self) -> None:
        ...
        assert (
            result.metadata.dbt_version
        ), "dbt_version required for OpenLineage producer"
        assert (
...
class TestParseManifest:
    """Tests for parsing dbt manifest.json file."""
    ...
    def test_parse_manifest(self) -> None:
        ...
        assert (
            len(test_node["refs"]) > 0
        ), "Test node should reference at least one model"
    ...
    def test_parse_manifest_malformed_json(self) -> None:
...
# =============================================================================
# Tests for resolve_test_to_model_node() and build_dataset_info()
# =============================================================================


@pytest.mark.unit
class TestResolveTestToModelNode:
    """Tests for resolving test to model node."""

    def test_resolve_test_to_model_node_and_build_dataset_info(self) -> None:
        ...
        ), "Should return DatasetInfo instance"
    ...
    def test_resolve_test_to_model_node_missing_reference(self) -> None:
...
class TestExtractProjectName:
    """Tests for extracting project name from test unique_id."""

    def test_extract_project_name_valid(self) -> None:
    ...
    def test_extract_project_name_invalid_format(self) -> None:
    ...
    def test_extract_project_name_empty_string(self) -> None:
...
class TestExtractModelName:
    """Tests for extracting model name from test node."""

    def test_get_model_name_from_test_valid(self) -> None:
    ...
    def test_get_model_name_from_test_multiple_refs(self) -> None:
    ...
    def test_get_model_name_from_test_no_refs(self) -> None:
    ...
    def test_get_model_name_from_test_empty_refs(self) -> None:
    ...
    def test_get_model_name_from_test_ref_without_name(self) -> None:
...
# =============================================================================
# Tests for map_test_status()
# =============================================================================


@pytest.mark.unit
class TestMapTestStatus:
    """Tests for mapping dbt test status to boolean."""

    def test_map_test_status_pass(self) -> None:
    ...
    def test_map_test_status_fail(self) -> None:
    ...
    def test_map_test_status_error(self) -> None:
    ...
    def test_map_test_status_skipped(self) -> None:
...
class TestBuildNamespace:
    """Tests for building namespace from manifest metadata."""

    def test_build_namespace_from_manifest(self) -> None:
    ...
    def test_build_namespace_with_override(self) -> None:
    ...
    def test_build_namespace_unknown_adapter(self) -> None:
    ...
    def test_build_namespace_empty_override_ignored(self) -> None:
        ...
        namespace = build_namespace(
            manifest, database="jaffle_shop", namespace_override=""
        )
...
# =============================================================================
# Tests for build_dataset_info()
# =============================================================================


@pytest.mark.unit
class TestBuildDatasetInfo:
    """Tests for building DatasetInfo from model/source node."""

    def test_build_dataset_info_from_model(self) -> None:
    ...
    def test_build_dataset_info_with_namespace_override(self) -> None:
    ...
    def test_build_dataset_info_with_alias(self) -> None:
        ...
        assert (
            dataset_info.name == "dbt_prod.customers"
        )  # Uses alias, not stg_customers

    def test_build_dataset_info_from_source(self) -> None:
    ...
    def test_build_dataset_info_source_with_different_identifier(self) -> None:
...
# =============================================================================
# Tests for extract_model_inputs()
# =============================================================================


@pytest.mark.unit
class TestExtractModelInputs:
    """Tests for extracting model inputs (dependencies)."""

    def test_extract_model_inputs_single_model_dependency(self) -> None:
    ...
    def test_extract_model_inputs_multiple_model_dependencies(self) -> None:
    ...
    def test_extract_model_inputs_no_dependencies(self) -> None:
    ...
    def test_extract_model_inputs_with_namespace_override(self) -> None:
    ...
    def test_extract_model_inputs_with_source_dependency(self) -> None:
    ...
    def test_extract_model_inputs_mixed_model_and_source(self) -> None:
...
@pytest.mark.unit
class TestGetModelsWithTests:
    """Tests for getting models with executed tests."""

    def test_get_models_with_tests_returns_unique_models(self) -> None:
    ...
    def test_get_models_with_tests_handles_multiple_tests_per_model(self) -> None:
        ...
        exact_customers_count = sum(
            1 for m in models if m == "model.jaffle_shop.customers"
        )
    ...
    def test_get_models_with_tests_empty_results(self) -> None:
...
# =============================================================================
# Tests for get_executed_models()
# =============================================================================


@pytest.mark.unit
class TestGetExecutedModels:
    """Tests for getting executed models from run results."""

    def test_get_executed_models_returns_model_ids(self) -> None:
    ...
    def test_get_executed_models_filters_non_models(self) -> None:
    ...
    def test_get_executed_models_empty_results(self) -> None:
        """Test handling of empty run_results.
...
# =============================================================================
# Tests for extract_all_model_lineage()
# =============================================================================


@pytest.mark.unit
class TestExtractAllModelLineage:
    """Tests for extracting lineage for all models."""

    def test_extract_all_model_lineage_returns_lineage_for_all_models(self) -> None:
        ...
        manifest_model_ids = {
            node for node in manifest.nodes if node.startswith("model.")
        }
        assert model_ids == manifest_model_ids

    def test_extract_all_model_lineage_with_filter(self) -> None:
    ...
    def test_extract_all_model_lineage_has_correct_inputs_and_output(self) -> None:
    ...
    def test_extract_all_model_lineage_with_namespace_override(self) -> None:
    ...
    def test_extract_all_model_lineage_empty_filter(self) -> None:
...
class TestModelExecutionResult:
    ...
    def test_model_execution_result_dataclass_creation(self) -> None:
    ...
    def test_model_execution_result_optional_fields(self) -> None:
...
# =============================================================================
# Tests for extract_model_results()
# =============================================================================


@pytest.mark.unit
class TestExtractModelResults:
    """Tests for extracting model execution results."""

    def test_extract_model_results_from_fixture(self) -> None:
    ...
    def test_extract_model_results_extracts_execution_time(self) -> None:
    ...
    def test_extract_model_results_extracts_status(self) -> None:
    ...
    def test_extract_model_results_handles_missing_rows_affected(self) -> None:
    ...
    def test_extract_model_results_extracts_rows_affected_when_present(self) -> None:
    ...
    def test_extract_model_results_filters_non_model_results(self) -> None:
    ...
    def test_extract_model_results_empty_run_results(self) -> None:
    ...
    def test_extract_model_results_handles_error_status(self) -> None:
    ...
    def test_extract_model_results_handles_skipped_status(self) -> None:
