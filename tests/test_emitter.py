...
Test Coverage:
    - TestGroupTestsByDataset: Group tests by target dataset
    - TestCreateWrappingEvent: Build START/COMPLETE/FAIL wrapping events
    - TestConstructTestEvents: Build OpenLineage events with test results
    - TestEmitEvents: Send events to OpenLineage backend
    - TestConstructLineageEvent: Build lineage events for single model
    - TestConstructLineageEvents: Build lineage events for multiple models
    - TestEmitEventsOpenLineageConsumerCompatibility: Consumer compatibility
"""
...
@pytest.mark.unit
class TestGroupTestsByDataset:
    """Tests for grouping tests by dataset URN."""

    def test_groups_by_dataset_urn(self, sample_run_results, sample_manifest) -> None:
    ...
    def test_multiple_tests_on_same_dataset(
    ...
    def test_includes_test_metadata(self, sample_run_results, sample_manifest) -> None:
...
@pytest.mark.unit
class TestCreateWrappingEvent:
    """Tests for creating wrapping events (START/COMPLETE/FAIL)."""
...
@pytest.mark.unit
class TestConstructTestEvents:
    """Tests for constructing OpenLineage test events with dataQualityAssertions."""

    def test_creates_valid_openlineage_event(
        self, sample_run_results, sample_manifest
    ) -> None:
    ...
    def test_includes_data_quality_assertions_facet(
        self, sample_run_results, sample_manifest
    ) -> None:
    ...
    def test_uses_correct_event_time(self, sample_run_results, sample_manifest) -> None:
        ...
        assert (
            actual_dt == expected_time
            or actual_dt.replace(tzinfo=None) == expected_time
    ...
    def test_with_custom_namespace_and_job_name(self) -> None:
...
class TestEmitEvents:
    """Tests for emitting events to Correlator/OpenLineage backend."""

    def test_sends_post_request_to_correlator(self, minimal_test_data) -> None:
        ...
        events = construct_test_events(
            ...
            "dbt",
            "test_job",
            "eb31681b-641b-4f73-bf93-cc339decae23",
        )
    ...
    def test_handles_success_response(self, minimal_test_data) -> None:
    ...
    def test_handles_partial_success_response(self, minimal_test_data) -> None:
    ...
    def test_with_api_key_includes_header(self, minimal_test_data) -> None:
    ...
    def test_handles_connection_error(self, minimal_test_data) -> None:
    ...
    def test_handles_http_error_response(self, minimal_test_data) -> None:
    ...
    def test_handles_timeout(self, minimal_test_data) -> None:
    ...
    def test_handles_empty_list(self) -> None:
        ...
        with patch("requests.post") as mock_post:
            ...
            ), "Should not make HTTP call for empty batch"


@pytest.mark.integration
class TestEmitEventsIntegration:
    """Integration tests for emit_events with real Correlator."""

    def test_integration_with_correlator(self) -> None:
...
class TestConstructLineageEvent:
    ...
    def test_includes_output(self, sample_model_lineage) -> None:
    ...
    def test_includes_runtime_metrics(
        self, sample_model_lineage, sample_model_execution_result
    ) -> None:
    ...
    def test_without_runtime_metrics(self, sample_model_lineage) -> None:
    ...
    def test_with_no_inputs(self) -> None:
...
@pytest.mark.unit
class TestConstructLineageEvents:
    """Tests for constructing lineage events for multiple models."""

    def test_creates_event_per_model(self, sample_model_lineages) -> None:
    ...
    def test_with_execution_results(self, sample_model_lineages) -> None:
        ...
        assert (
            customers_event.outputs[0].outputFacets["outputStatistics"].rowCount == 2500
        )

        # stg_customers should NOT have outputStatistics
        assert stg_customers_event.outputs[0].outputFacets is None or (
            "outputStatistics"
            not in (stg_customers_event.outputs[0].outputFacets or {})
        )
...
@pytest.mark.unit
class TestEmitEventsOpenLineageConsumerCompatibility:
    """Tests for emit_events() compatibility with various OpenLineage consumers."""

    def test_handles_204_no_content(self, minimal_test_data) -> None:
    ...
    def test_handles_200_with_body(self, minimal_test_data) -> None:
    ...
    def test_handles_200_without_body(self, minimal_test_data) -> None:
    ...
    def test_with_lineage_events(self, sample_model_lineage) -> None:
